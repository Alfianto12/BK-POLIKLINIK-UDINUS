...
<body>
    ...
    <section class="content">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div style="background-image: url('assets/images/1.jpg'); background-size: cover; height: 200px; position: relative;">
                <marquee style="position: absolute; bottom: 0; background-color: rgba(0,0,0,0.5); color: white; width: 100%; padding: 30px;">
                    <h2>Selamat Datang di Menu Admin - Pakai Masker - Tetap Jaga Protokol Kesehatan!</h2>
                </marquee>
                </div>
            </div>
        </div>
